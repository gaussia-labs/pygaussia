...
from gaussia.prompt_optimizer.mipro.prompts import INSTRUCTION_PROPOSAL_SYSTEM, INSTRUCTION_PROPOSAL_USER
from gaussia.prompt_optimizer.schemas import Demo
