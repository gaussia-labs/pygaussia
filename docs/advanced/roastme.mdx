...
You implement against these. Seven ship a reference implementation, declared as such — a convenience,
...
- **The mention extractor reads compound identifiers, and a corpus of ordinary words defeats it.**
  ...
  phone numbers, PDF filenames, footer anchors — and nothing fails: each becomes a probe. Print what
  it extracts before trusting a run, or supply an enumerator and use `EnumerationProbeEngine`.
