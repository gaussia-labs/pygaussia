...
<CardGroup cols={3}>
  ...
  <Card title="Privacy" icon="user-shield" href="/metrics/privacy">
    Score and rank PII/PHI detectors for a regulated domain, with a risk index.
  </Card>
</CardGroup>
...
| **Privacy** | Score/rank PII detectors (scores the detector, not the assistant) | Per-dataset score + risk | No |
